...
import { ShoppingBag, ArrowLeft, CheckCircle2, Loader2, ShieldCheck, Truck, CreditCard, Minus, Plus, Trash2 } from "lucide-react";
            ...
            <div className="min-h-screen bg-white flex flex-col">
                ...
                <main className="flex-1 flex items-center justify-center p-4 pt-32">
                    <div className="max-w-md w-full bg-pink-50/50 rounded-[40px] p-12 text-center border-2 border-dashed border-pink-100 animate-in zoom-in-95 duration-500">
                        ...
                        <h1 className="text-3xl font-black text-[#003366] mb-4">Treasure Secured!</h1>
                        <p className="text-gray-500 font-bold mb-8">
                            Your order has been placed successfully. We'll contact you soon for confirmation.
                        </p>
                        <Link href="/">
        ...
        <div className="min-h-screen bg-white flex flex-col font-sans">
            ...
            <main className="flex-1 pt-32 pb-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Breadcrumbs / Back */}
                    <Link href="/" className="inline-flex items-center text-gray-400 hover:text-[#FF8BBA] font-bold mb-8 transition-colors group">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                        ...
                        <div className="lg:col-span-7">
                            <div className="mb-10">
                                <h1 className="text-4xl font-black text-[#003366] tracking-tight mb-2">Checkout</h1>
                                <p className="text-gray-400 font-bold">Complete your purchase by providing your shipping details.</p>
                            </div>
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                <div className="p-8 rounded-[32px] bg-white border border-pink-50 shadow-sm space-y-6">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <h2 className="text-xl font-black text-[#003366]">Guest Information</h2>
                                    </div>

                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <Label htmlFor="fullName" className="text-[#003366] font-bold ml-1">Full Name</Label>
                                            <Input 
                                                id="fullName"
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="phoneNumber" className="text-[#003366] font-bold ml-1">Phone Number (8 digits)</Label>
                                            <Input 
                                                id="phoneNumber"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <Label className="text-[#003366] font-bold ml-1">Governorate</Label>
                                            <Select onValueChange={(v) => form.setValue("governorate", v, { shouldValidate: true })}>
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-[#003366] font-bold ml-1">City / Delegation</Label>
                                            <Select 
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="detailedAddress" className="text-[#003366] font-bold ml-1">Detailed Address</Label>
                                        <Input 
                                            id="detailedAddress"
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center gap-4 p-4 rounded-[2rem] bg-purple-50/50 border border-purple-100">
                                        ...
                                        <div>
                                            <h4 className="text-sm font-black text-[#003366]">Cash on Delivery</h4>
                                            <p className="text-xs text-purple-400 font-bold uppercase tracking-wider">Pay when you receive your treasure</p>
                                        </div>
                                    </div>
                            ...
                            <div className="sticky top-40 space-y-6">
                                <div className="bg-[#A78BFA] rounded-[40px] p-8 text-white shadow-2xl shadow-purple-200/50 overflow-hidden relative">
                                    ...
                                    <div className="space-y-4 pt-6 border-t border-white/20">
                                        <div className="flex justify-between items-center text-purple-50 font-bold">
                                            <span>Subtotal</span>
                                            <span className="text-white font-black">{totalPrice.toFixed(2)} DT</span>
                                        </div>
                                        <div className="flex justify-between items-center text-purple-50 font-bold">
                                            <span>Shipping</span>
                                        ...
                                        <div className="flex justify-between items-end">
                                            <div>
                                                <p className="text-purple-50 text-[10px] font-black uppercase tracking-widest">Total to pay</p>
                                                <p className="text-4xl font-black tracking-tight">{finalTotal.toFixed(2)} DT</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-4 rounded-3xl bg-gray-50 flex flex-col items-center text-center gap-2 border border-gray-100">
                                        ...
                                        <p className="text-[10px] font-black text-[#003366] uppercase tracking-wider text-center">Quality Guaranteed</p>
                                    </div>
                                    <div className="p-4 rounded-3xl bg-gray-50 flex flex-col items-center text-center gap-2 border border-gray-100">
                                        <Truck className="w-5 h-5 text-[#A78BFA]" />
                                        <p className="text-[10px] font-black text-[#003366] uppercase tracking-wider text-center">Fast Delivery</p>
                                    </div>
                                </div>
                            </div>
                        </div>
