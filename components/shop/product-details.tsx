    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-6 animate-in fade-in zoom-in duration-500">
        ...
        <div className="space-y-2">
          <h2 className="text-3xl font-black text-[#3E343C]">
            Order Placed! ✨
          </h2>
          <p className="text-[#8B7E84] max-w-md">
            Thank you for your order, {product.name} will be with you soon. We
            will contact you by phone to confirm the details.
          </p>
        </div>
        <Button
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
      ...
      <div className="flex flex-col gap-8">
        ...
        <form
          ...
          className="space-y-6 pt-6 border-t border-dotted border-pink-100"
        >
          <div className="flex items-center gap-2 mb-2">
            <span className="text-sm font-black text-[#3E343C] uppercase tracking-wider">
              Quick Order Details
            </span>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-[10px] font-black text-[#8B7E84] uppercase tracking-[0.2em] ml-4">
                  Full Name
                </Label>
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`h-12 rounded-full pl-12 bg-gray-50/50 border-gray-100 focus:bg-white focus:border-[#FF8BBA] focus:ring-4 focus:ring-pink-50 transition-all text-sm font-medium ${
                      form.formState.errors.fullName ? "border-red-300" : ""
                    }`}
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    maxLength={8}
                    className={`h-12 rounded-full pl-12 bg-gray-50/50 border-gray-100 focus:bg-white focus:border-[#FF8BBA] focus:ring-4 focus:ring-pink-50 transition-all text-sm font-medium ${
                      form.formState.errors.phoneNumber ? "border-red-300" : ""
                    }`}
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    className={`!h-12 rounded-full px-6 bg-gray-50/50 border-gray-100 focus:bg-white focus:border-[#FF8BBA] focus:ring-4 focus:ring-pink-50 transition-all text-sm font-medium w-full ${
                      form.formState.errors.governorate ? "border-red-300" : ""
                    }`}
                  >
                  ...
                  <SelectContent
                    position="popper"
                    className="rounded-2xl border-pink-50 shadow-xl max-h-48 bg-white"
                  >
                    {TUNISIA_GOVERNORATES.map((gov) => (
                      <SelectItem
                        key={gov}
                        value={gov}
                        className="rounded-xl focus:bg-pink-50 focus:text-[#FF8BBA]"
                      >
                        {gov}
                      </SelectItem>
                    ))}
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    className={`!h-12 rounded-full px-6 bg-gray-50/50 border-gray-100 focus:bg-white focus:border-[#FF8BBA] focus:ring-4 focus:ring-pink-50 transition-all text-sm font-medium w-full disabled:opacity-50 ${
                      form.formState.errors.city ? "border-red-300" : ""
                    }`}
                  >
                    <SelectValue
                      placeholder={
                        selectedGov ? "Select city" : "Choose state first"
                      }
                    />
                  </SelectTrigger>
                  <SelectContent
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className={`min-h-20 rounded-[1.5rem] p-4 bg-gray-50/50 border-gray-100 focus:bg-white focus:border-[#FF8BBA] focus:ring-4 focus:ring-pink-50 transition-all text-sm font-medium ${
                  form.formState.errors.detailedAddress ? "border-red-300" : ""
                }`}
              />
            ...
            <div className="flex items-center justify-between p-4 rounded-[1.5rem] bg-gray-50/50 border border-gray-100">
              ...
              <div className="flex items-center gap-4 bg-white rounded-full p-1 shadow-sm border border-gray-100">
                ...
                <span className="w-8 text-center font-black text-[#3E343C]">
                  {quantity}
                </span>
                <button
                  type="button"
